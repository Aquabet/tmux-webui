...
export const THEMES: readonly ThemeDefinition[] = [
  {
    id: 'tokyo-night', label: 'Tokyo Night', description: '冷静的深蓝与霓虹蓝',
    preview: tokyoNight,
    terminal: createTerminalTheme(tokyoNight, {
      black: '#15161e', blue: '#7aa2f7', cyan: '#7dcfff',
      magenta: '#bb9af7', brightBlack: '#565f89',
    }),
  },
  {
    id: 'catppuccin-mocha', label: 'Catppuccin Mocha', description: '柔和的摩卡与薰衣草色',
    preview: catppuccin,
    terminal: createTerminalTheme(catppuccin, {
      black: '#181825', blue: '#89b4fa', cyan: '#89dceb',
      magenta: '#cba6f7', brightBlack: '#6c7086',
    }),
  },
  {
    id: 'dracula', label: 'Dracula', description: '高对比紫色经典配色',
    preview: dracula,
    terminal: createTerminalTheme(dracula, {
      black: '#21222c', blue: '#6272a4', cyan: '#8be9fd',
      magenta: '#ff79c6', brightBlack: '#6272a4',
    }),
  },
  {
    id: 'nord', label: 'Nord', description: '低饱和的北欧冰川色', preview: nord,
    terminal: createTerminalTheme(nord, {
      black: '#242933', blue: '#81a1c1', cyan: '#8fbcbb',
      magenta: '#b48ead', brightBlack: '#7b88a1',
    }),
  },
  {
    id: 'solarized-dark', label: 'Solarized Dark', description: '护眼的经典蓝绿色调',
    preview: solarized,
    terminal: createTerminalTheme(solarized, {
      black: '#073642', blue: '#268bd2', cyan: '#2aa198',
      magenta: '#6c71c4', brightBlack: '#586e75',
    }),
  },
  {
    id: 'gruvbox-dark', label: 'Gruvbox Dark', description: '复古温暖的高可读配色',
    preview: gruvbox,
    terminal: createTerminalTheme(gruvbox, {
      black: '#1d2021', blue: '#83a598', cyan: '#8ec07c',
      magenta: '#d3869b', brightBlack: '#928374',
    }),
  },
]

export const FONT_OPTIONS: readonly FontDefinition[] = [
  { id: 'system-mono', label: 'System Mono', stack: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", monospace' },
  { id: 'jetbrains-mono', label: 'JetBrains Mono', stack: '"JetBrains Mono", ui-monospace, monospace' },
  { id: 'cascadia-mono', label: 'Cascadia Mono', stack: '"Cascadia Mono", "Cascadia Code", ui-monospace, monospace' },
...
const isAppearanceSettings = (value: unknown): value is AppearanceSettings => {
  ...
  return THEMES.some(({ id }) => id === candidate.theme)
